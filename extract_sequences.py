from bxad_lib import sequences
import config
...
if __name__ == "__main__":
    ...
    print(f"Current memory usage: {process.memory_info().rss / 1e6:.3f} MB", flush=True)

    """
    Auxiliary data on colliding bunches
    """
    cbx_mask = get_fill_data(DATA_PATH + "/25ns_2352b_2340_2004_2133_108bpi_24inj.json")
